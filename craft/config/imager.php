...
return array(
  ...
  'useCwebp' => true,
  // 'cwebpPath' => '/usr/local/Cellar/webp/0.6.0_2',
  'cwebpPath' => '/opt/local/bin/cwebp',
  ...
  'jpegoptimPath' => '/usr/local/Cellar/jpegoptim/1.4.4_1',
  ...
  'optipngEnabled' => true,
  'optipngPath' => '/usr/local/Cellar/optipng/0.7.6',
